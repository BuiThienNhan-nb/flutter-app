...
import 'package:flutter_app/screen/splash/intro/intro.dart';

class Onbroad extends StatefulWidget {
  @override
  _OnbroadState createState() => _OnbroadState();
}

class _OnbroadState extends State<Onbroad> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return IntroductionScreen(
        ...
        onDone: () => Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (_) => MyHomePage(title: 'hello'))),
        showSkipButton: true,
        skip: Text('skip'),
